...
namespace VSPROEKT
{
    public partial class Game : Form
    {
        ...
        {
            //System.IO.Directory.GetCurrentDirectory(); vraka absolutna pateka do exe fajlot
                                           
            //pateka do folderot kade se naoga solution file
            string filePath = Directory.GetParent (Directory.GetParent(Directory.GetParent(Directory.GetCurrentDirectory()).FullName).FullName).FullName;
